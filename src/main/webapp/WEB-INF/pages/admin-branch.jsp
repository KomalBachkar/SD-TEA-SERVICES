    ...
    <section class="section">
      <div class="row">
        <div class="col-lg-12">
          ...
          <div class="card">
            <div class="card-body">
              <h5 class="card-title">Add Branch Details</h5>
              ...
              <form action="${action}" method="post" class="row g-3 needs-validation" novalidate>
                ...
                <div class="row mb-3">
                  <label for="branchLocation" class="col-sm-2 col-form-label">Location</label>
                  <div class="col-sm-10">
                    <input type="text" class="form-control" id="branchLocation" name="branchLocation">
                  </div>
                </div>
                <div class="row mb-3">
                  <label for="branchOwnerName" class="col-sm-2 col-form-label">Owner Name</label>
                  <div class="col-sm-10">
                    <input type="text" class="form-control" id="branchOwnerName" name="branchOwnerName">
                  </div>
                </div>
                
                 <div class="row mb-3">
                  <label for="branchAddress" class="col-sm-2 col-form-label">Address</label>
                  <div class="col-sm-10">
                 ...
                 <div class="row mb-3">
                  <label for="emailId" class="col-sm-2 col-form-label">EmailId</label>
                  <div class="col-sm-10">
